...
best_rfr1, r2_rfr1, rmse_rfr1, mae_rfr1 = evaluate_model(rfr, param_grid_rfr, X1_train, y1_train, X1_test, y1_test, 'RFR', 'uspto', 'uspto', 'rxnfp')
#best_rfr1 = joblib.load("RFR_uspto_uspto_rxnfp_model.pkl")
...
r2_eval_rfr_3, rmse_eval_rfr_3, mae_eval_rfr_3 = test(best_rfr1, X3, y3, best_rfr1.get_params(), 'uspto', 'hte_bh', 'RXNFP', 'RFR')
r2_eval_rfr_3_2, rmse_eval_rfr_3_2, mae_eval_rfr_3_2 = test(best_rfr1_2, X3_2, y3, best_rfr1_2.get_params(), 'uspto', 'hte_bh', 'DRFP', 'RFR')


r2_eval_rfr_2, rmse_eval_rfr_2, mae_eval_rfr_2 = test(best_rfr1, X2, y2, best_rfr1.get_params(), 'uspto', 'reaxys', 'RXNFP', 'RFR')
r2_eval_rfr_2_2, rmse_eval_rfr_2_2, mae_eval_rfr_2_2 = test(best_rfr1_2, X2_2, y2, best_rfr1_2.get_params(), 'uspto', 'reaxys', 'DRFP', 'RFR')


r2_eval_rfr_4, rmse_eval_rfr_4, mae_eval_rfr_4 = test(best_rfr1, X4, y4, best_rfr1.get_params(), 'uspto', 'az_eln', 'RXNFP', 'RFR')
