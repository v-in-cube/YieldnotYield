...
best_svr1, r2_svr1, rmse_svr1, mae_svr1 = evaluate_model(svr, param_grid_svr, X1_train, y1_train, X1_test, y1_test, 'SVR', 'uspto', 'uspto', 'rxnfp')
...
r2_eval_svr_3, rmse_eval_svr_3, mae_eval_svr_3 = test(best_svr1, X3, y3, best_svr1.get_params(), 'uspto', 'hte_bh', 'RXNFP', 'SVR')
r2_eval_svr_3_2, rmse_eval_svr_3_2, mae_eval_svr_3_2 = test(best_svr1_2, X3_2, y3, best_svr1_2.get_params(), 'uspto', 'hte_bh', 'DRFP', 'SVR')


r2_eval_svr_2, rmse_eval_svr_2, mae_eval_svr_2 = test(best_svr1, X2, y2, best_svr1.get_params(), 'uspto', 'reaxys', 'RXNFP', 'SVR')
r2_eval_svr_2_2, rmse_eval_svr_2_2, mae_eval_svr_2_2 = test(best_svr1_2, X2_2, y2, best_svr1_2.get_params(), 'uspto', 'reaxys', 'DRFP', 'SVR')


r2_eval_svr_4, rmse_eval_svr_4, mae_eval_svr_4 = test(best_svr1, X4, y4, best_svr1.get_params(), 'uspto', 'az_eln', 'RXNFP', 'SVR')
r2_eval_svr_4_1, rmse_eval_svr_4_1, mae_eval_svr_4_1 = test(best_svr1_2, X4_2, y4, best_svr1_2.get_params(), 'uspto', 'az_eln', 'DRFP', 'SVR')
