...
best_svr2, r2_svr2, rmse_svr2, mae_svr2 = evaluate_model(svr, param_grid_svr, X2_train, y2_train, X2_test, y2_test, 'SVR', 'reaxys', 'reaxys', 'rxnfp')
...
#best_svr2 = joblib.load("SVR_reaxys_reaxys_rxnfp_model.pkl")


r2_eval_svr_3, rmse_eval_svr_3, mae_eval_svr_3 = test(best_svr2, X3, y3, best_svr2.get_params(), 'reaxys', 'hte_bh', 'RXNFP', 'SVR')
...
r2_eval_svr_4, rmse_eval_svr_4, mae_eval_svr_4 = test(best_svr2, X4, y4, best_svr2.get_params(), 'reaxys', 'az_eln', 'RXNFP', 'SVR')
...
r2_eval_svr_1, rmse_eval_svr_1, mae_eval_svr_1 = test(best_svr2, X1, y1, best_svr2.get_params(), 'reaxys', 'uspto', 'RXNFP', 'SVR')
