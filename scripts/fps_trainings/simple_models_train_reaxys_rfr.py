...
best_rfr2, r2_rfr2, rmse_rfr2, mae_rfr2 = evaluate_model(rfr, param_grid_rfr, X2_train, y2_train, X2_test, y2_test, 'RFR', 'reaxys', 'reaxys', 'rxnfp')
...
#best_rfr2 = joblib.load("RFR_reaxys_reaxys_rxnfp_model.pkl")


r2_eval_rfr_3, rmse_eval_rfr_3, mae_eval_rfr_3 = test(best_rfr2, X3, y3, best_rfr2.get_params(), 'reaxys', 'hte_bh', 'RXNFP', 'RFR')
...
r2_eval_rfr_4, rmse_eval_rfr_4, mae_eval_rfr_4 = test(best_rfr2, X4, y4, best_rfr2.get_params(), 'reaxys', 'az_eln', 'RXNFP', 'RFR')
...
r2_eval_rfr_1, rmse_eval_rfr_1, mae_eval_rfr_1 = test(best_rfr2, X1, y1, best_rfr2.get_params(), 'reaxys', 'uspto', 'RXNFP', 'RFR')
