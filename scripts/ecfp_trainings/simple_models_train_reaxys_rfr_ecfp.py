...
def evaluate_model(model, param_grid, X_train, y_train, X_test, y_test, model_name, train_dataset_name, test_dataset_name, fps_name):
    ...
    grid_search = GridSearchCV(model, param_grid, cv=5, n_jobs=20, verbose =2)
...
#best_rfr2, r2_rfr2, rmse_rfr2, mae_rfr2 = evaluate_model(rfr, param_grid_rfr, X2_train, y2_train, X2_test, y2_test, 'RFR', 'reaxys', 'reaxys', 'ecfp4')
best_rfr2_1, r2_rfr2_1, rmse_rfr2_1, mae_rfr2_1 = evaluate_model(rfr, param_grid_rfr, X2_1train, y2_1train, X2_1test, y2_1test, 'RFR', 'reaxys', 'reaxys', 'ecfp4_6')
#best_rfr2_2, r2_rfr2_2, rmse_rfr2_2, mae_rfr2_2 = evaluate_model(rfr, param_grid_rfr, X2_2train, y2_2train, X2_2test, y2_2test, 'RFR', 'reaxys', 'reaxys', 'drfp')

best_rfr2 = joblib.load("RFR_reaxys_reaxys_ecfp4_model.pkl")
# best_rfr2_1 = joblib.load("RFR_reaxys_reaxys_mhfp6_model.pkl")


r2_eval_rfr_3, rmse_eval_rfr_3, mae_eval_rfr_3 = test(best_rfr2, X3, y3, best_rfr2.get_params(), 'reaxys', 'hte_bh', 'ecfp4', 'RFR')
r2_eval_rfr_3_1, rmse_eval_rfr_3_1, mae_eval_rfr_3_1 = test(best_rfr2_1, X3_1, y3, best_rfr2_1.get_params(), 'reaxys', 'hte_bh', 'ecfp4_6', 'RFR')
#r2_eval_rfr_3_2, rmse_eval_rfr_3_2, mae_eval_rfr_3_2 = test(best_rfr2_2, X3_2, y3, best_rfr2_2.get_params(), 'reaxys', 'hte_bh', 'DRFP', 'RFR')



r2_eval_rfr_4, rmse_eval_rfr_4, mae_eval_rfr_4 = test(best_rfr2, X4, y4, best_rfr2.get_params(), 'reaxys', 'az_eln', 'ecfp4', 'RFR')
r2_eval_rfr_4_1, rmse_eval_rfr_4_1, mae_eval_rfr_4_1 = test(best_rfr2_1, X4_1, y4, best_rfr2_1.get_params(), 'reaxys', 'ecfp4_6', 'MHFP6', 'RFR')
#r2_eval_rfr_4_2, rmse_eval_rfr_4_2, mae_eval_rfr_4_2 = test(best_rfr2_2, X4_2, y4, best_rfr2_2.get_params(), 'reaxys', 'az_eln', 'DRFP', 'RFR')


r2_eval_rfr_1, rmse_eval_rfr_1, mae_eval_rfr_1 = test(best_rfr2, X1, y1, best_rfr2.get_params(), 'reaxys', 'uspto', 'ecfp4', 'RFR')
r2_eval_rfr_1_1, rmse_eval_rfr_1_1, mae_eval_rfr_1_1 = test(best_rfr2_1, X1_1, y1, best_rfr2_1.get_params(), 'reaxys', 'uspto', 'ecfp4_6', 'RFR')
#r2_eval_rfr_1_2, rmse_eval_rfr_1_2, mae_eval_rfr_1_2 = test(best_rfr2_2, X1_2, y1, best_rfr2_2.get_params(), 'reaxys', 'uspto', 'DRFP', 'RFR')
