...
best_gbr3, r2_gbr3, rmse_gbr3, mae_gbr3 = evaluate_model(gbr, param_grid_gbr, X3_train, y3_train, X3_test, y3_test, 'GBR', 'hte', 'hte', 'ecfp4')
best_gbr3_1, r2_gbr3_1, rmse_gbr3_1, mae_gbr3_1 = evaluate_model(gbr, param_grid_gbr, X3_1train, y3_1train, X3_1test, y3_1test, 'GBR', 'hte', 'hte', 'ecfp4_6')
#best_gbr3_2, r2_gbr3_2, rmse_gbr3_2, mae_gbr3_2 = evaluate_model(gbr, param_grid_gbr, X3_2train, y3_2train, X3_2test, y3_2test, 'GBR', 'hte', 'hte', 'drfp')
