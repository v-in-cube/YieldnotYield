...
#X3_2train, X3_2test, y3_2train, y3_2test = train_test_split(X3_2, y3, test_size=0.3, random_state=42)
...
best_gbr3, r2_gbr3, rmse_gbr3, mae_gbr3 = evaluate_model(svr, param_grid_svr, X3_train, y3_train, X3_test, y3_test, 'SVR', 'hte', 'hte', 'ecfp4')
best_gbr3_1, r2_gbr3_1, rmse_gbr3_1, mae_gbr3_1 = evaluate_model(svr, param_grid_svr, X3_1train, y3_1train, X3_1test, y3_1test, 'SVR', 'hte', 'hte', 'ecfp4_6')
#best_gbr3_2, r2_gbr3_2, rmse_gbr3_2, mae_gbr3_2 = evaluate_model(svr, param_grid_svr, X3_2train, y3_2train, X3_2test, y3_2test, 'SVR', 'hte', 'hte', 'drfp')
