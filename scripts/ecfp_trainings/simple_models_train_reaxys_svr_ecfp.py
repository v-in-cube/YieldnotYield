...
#best_svr2, r2_svr2, rmse_svr2, mae_svr2 = evaluate_model(svr, param_grid_svr, X2_train, y2_train, X2_test, y2_test, 'SVR', 'reaxys', 'reaxys', 'ecfp4')
#best_svr2_1, r2_svr2_1, rmse_svr2_1, mae_svr2_1 = evaluate_model(svr, param_grid_svr, X2_1train, y2_1train, X2_1test, y2_1test, 'SVR', 'reaxys', 'reaxys', 'ecfp4_6')
#best_svr2_2, r2_svr2_2, rmse_svr2_2, mae_svr2_2 = evaluate_model(svr, param_grid_svr, X2_2train, y2_2train, X2_2test, y2_2test, 'SVR', 'reaxys', 'reaxys', 'drfp')
best_svr2 = joblib.load("SVR_reaxys_reaxys_ecfp4_model.pkl")
best_svr2_1 = joblib.load("SVR_reaxys_reaxys_ecfp4_6_model.pkl")

r2_eval_svr_3, rmse_eval_svr_3, mae_eval_svr_3 = test(best_svr2, X3, y3, best_svr2.get_params(), 'reaxys', 'hte_bh', 'ecfp4', 'SVR')
r2_eval_svr_3_1, rmse_eval_svr_3_1, mae_eval_svr_3_1 = test(best_svr2_1, X3_1, y3, best_svr2_1.get_params(), 'reaxys', 'hte_bh', 'ecfp4_6', 'SVR')
#r2_eval_svr_3_2, rmse_eval_svr_3_2, mae_eval_svr_3_2 = test(best_svr2_2, X3_2, y3, best_svr2_2.get_params(), 'reaxys', 'hte_bh', 'DRFP', 'SVR')


r2_eval_svr_4, rmse_eval_svr_4, mae_eval_svr_4 = test(best_svr2, X4, y4, best_svr2.get_params(), 'reaxys', 'az_eln', 'ecfp4', 'SVR')
r2_eval_svr_4_1, rmse_eval_svr_4_1, mae_eval_svr_4_1 = test(best_svr2_1, X4_1, y4, best_svr2_1.get_params(), 'reaxys', 'az_eln', 'ecfp4_6', 'SVR')
#r2_eval_svr_4_2, rmse_eval_svr_4_2, mae_eval_svr_4_2 = test(best_svr2_2, X4_2, y4, best_svr2_2.get_params(), 'reaxys', 'az_eln', 'DRFP', 'SVR')


r2_eval_svr_1, rmse_eval_svr_1, mae_eval_svr_1 = test(best_svr2, X1, y1, best_svr2.get_params(), 'reaxys', 'uspto', 'ecfp4', 'SVR')
r2_eval_svr_1_1, rmse_eval_svr_1_1, mae_eval_svr_1_1 = test(best_svr2_1, X1_1, y1, best_svr2_1.get_params(), 'reaxys', 'uspto', 'ecfp4_6', 'SVR')
#r2_eval_svr_1_2, rmse_eval_svr_1_2, mae_eval_svr_1_2 = test(best_svr2_2, X1_2, y1, best_svr2_2.get_params(), 'reaxys', 'uspto', 'DRFP', 'SVR')
