...
best_gbr1, r2_gbr1, rmse_gbr1, mae_gbr1 = evaluate_model(gbr, param_grid_gbr, X1_train, y1_train, X1_test, y1_test, 'GBR', 'uspto', 'uspto', 'ecfp4')
best_gbr1_1, r2_gbr1_1, rmse_gbr1_1, mae_gbr1_1 = evaluate_model(gbr, param_grid_gbr, X1_1train, y1_1train, X1_1test, y1_1test, 'GBR', 'uspto', 'uspto', 'ecfp4_6')
...
# best_gbr1_1 = joblib.load("GBR_uspto_uspto_mhfp6_model.pkl")

r2_eval_gbr_3, rmse_eval_gbr_3, mae_eval_gbr_3 = test(best_gbr1, X3, y3, best_gbr1.get_params(), 'uspto', 'hte_bh', 'ecfp4', 'GBR')
r2_eval_gbr_3_1, rmse_eval_gbr_3_1, mae_eval_gbr_3_1 = test(best_gbr1_1, X3_1, y3, best_gbr1_1.get_params(), 'uspto', 'hte_bh', 'ecfp4_6', 'GBR')
#r2_eval_gbr_3_2, rmse_eval_gbr_3_2, mae_eval_gbr_3_2 = test(best_gbr1_2, X3_2, y3, best_gbr1_2.get_params(), 'uspto', 'hte_bh', 'DRFP', 'GBR')


r2_eval_gbr_2, rmse_eval_gbr_2, mae_eval_gbr_2 = test(best_gbr1, X2, y2, best_gbr1.get_params(), 'uspto', 'reaxys', 'ecfp4', 'GBR')
r2_eval_gbr_2_1, rmse_eval_gbr_2_1, mae_eval_gbr_2_1 = test(best_gbr1_1, X2_1, y2, best_gbr1_1.get_params(), 'uspto', 'reaxys', 'ecfp4_6', 'GBR')
#r2_eval_gbr_2_2, rmse_eval_gbr_2_2, mae_eval_gbr_2_2 = test(best_gbr1_2, X2_2, y2, best_gbr1_2.get_params(), 'uspto', 'reaxys', 'DRFP', 'GBR')



r2_eval_gbr_4, rmse_eval_gbr_4, mae_eval_gbr_4 = test(best_gbr1, X4, y4, best_gbr1.get_params(), 'uspto', 'az_eln', 'ecfp4', 'GBR')
r2_eval_gbr_4_1, rmse_eval_gbr_4_1, mae_eval_gbr_4_1 = test(best_gbr1_1, X4_1, y4, best_gbr1_1.get_params(), 'uspto', 'az_eln', 'ecfp4_6', 'GBR')
#r2_eval_gbr_4_1, rmse_eval_gbr_4_1, mae_eval_gbr_4_1 = test(best_gbr1_1, X4_1, y4, best_gbr1_2.get_params(), 'uspto', 'az_eln', 'DRFP', 'GBR')
