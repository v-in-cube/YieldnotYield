...
#best_svr1, r2_svr1, rmse_svr1, mae_svr1 = evaluate_model(svr, param_grid_svr, X1_train, y1_train, X1_test, y1_test, 'SVR', 'uspto', 'uspto', 'ecfp4')
best_svr1_1, r2_svr1_1, rmse_svr1_1, mae_svr1_1 = evaluate_model(svr, param_grid_svr, X1_1train, y1_1train, X1_1test, y1_1test, 'SVR', 'uspto', 'uspto', 'ecfp4_6')
#best_svr1_2, r2_svr1_2, rmse_svr1_2, mae_svr1_2 = evaluate_model(svr, param_grid_svr, X1_2train, y1_2train, X1_2test, y1_2test, 'SVR', 'uspto', 'uspto', 'drfp')


#best_svr1 = joblib.load("SVR_uspto_uspto_rxnfp_model.pkl")
best_svr1 = joblib.load("SVR_uspto_uspto_ecfp4_model.pkl")


r2_eval_svr_3, rmse_eval_svr_3, mae_eval_svr_3 = test(best_svr1, X3, y3, best_svr1.get_params(), 'uspto', 'hte_bh', 'ecfp4', 'SVR')
r2_eval_svr_3_1, rmse_eval_svr_3_1, mae_eval_svr_3_1 = test(best_svr1_1, X3_1, y3, best_svr1_1.get_params(), 'uspto', 'hte_bh', 'ecfp4_6', 'SVR')
#r2_eval_svr_3_2, rmse_eval_svr_3_2, mae_eval_svr_3_2 = test(best_svr1_2, X3_2, y3, best_svr1_2.get_params(), 'uspto', 'hte_bh', 'DRFP', 'SVR')


r2_eval_svr_2, rmse_eval_svr_2, mae_eval_svr_2 = test(best_svr1, X2, y2, best_svr1.get_params(), 'uspto', 'reaxys', 'ecfp4', 'SVR')
r2_eval_svr_2_1, rmse_eval_svr_2_1, mae_eval_svr_2_1 = test(best_svr1_1, X2_1, y2, best_svr1_1.get_params(), 'uspto', 'reaxys', 'ecfp4_6', 'SVR')
#r2_eval_svr_2_2, rmse_eval_svr_2_2, mae_eval_svr_2_2 = test(best_svr1_2, X2_2, y2, best_svr1_2.get_params(), 'uspto', 'reaxys', 'DRFP', 'SVR')


r2_eval_svr_4, rmse_eval_svr_4, mae_eval_svr_4 = test(best_svr1, X4, y4, best_svr1.get_params(), 'uspto', 'az_eln', 'ecfp4', 'SVR')
r1_eval_svr_4_1, rmse_eval_svr_4_1, mae_eval_svr_4_1 = test(best_svr1_1, X4_1, y4, best_svr1_1.get_params(), 'uspto', 'az_eln', 'ecfp4_6', 'SVR')
#r2_eval_svr_4_1, rmse_eval_svr_4_1, mae_eval_svr_4_1 = test(best_svr1_1, X4_1, y4, best_svr1_2.get_params(), 'uspto', 'az_eln', 'DRFP', 'SVR')
